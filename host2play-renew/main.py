    ...
    try:
        with create_uc_page(proxy_addr) as page:
            ...
            try:
                ...
                if onclick_attr:
                    print(f"  Button onclick attr: {onclick_attr[:300]}")
                    # Try to extract a function call from the onclick attribute.
                    # Supports:
                    #   funcName()                 — no args (e.g. renew())
                    #   funcName('arg')            — single string arg
                    #   funcName("arg")            — single string arg, double quotes
                    ...
                    if fn_name:
                        ...
                        print(f"  No function call pattern found in onclick attr")
            except Exception as e:
